...
# Monitor UDP/DNS packets/bytes to target ip per time interval
udp_pkts, udp_byts, dns_pkts, dns_byts = [], [], [], []
monitor(files, target_prot, 'ANY', target_ip, time_interval, udp_pkts, udp_byts)
monitor(files, target_prot, target_sport, target_ip, time_interval, dns_pkts, dns_byts)

datas = [udp_pkts, udp_byts, dns_pkts, dns_byts]
outfiles = ['udp_pkts.txt', 'udp_byts.txt', 'dns_pkts.txt', 'dns_byts.txt']
